...
public static class SandboxUtils
{
	...
	{
		SpawnableInstance spawnableInstance = from.GetComponent<SpawnableInstance>();
		if ((bool)spawnableInstance && !spawnableInstance.enabled)
		{
			return null;
		}
		if (!spawnableInstance)
		{
			...
			{
				spawnableInstance = component.parent;
			}
		}
		if (!spawnableInstance)
		{
			...
			{
				spawnableInstance = component2.eid.GetComponent<SpawnableInstance>();
				if (spawnableInstance == null)
				{
					spawnableInstance = component2.eid.GetComponentInParent<SpawnableInstance>();
				}
			}
		}
		if (!spawnableInstance)
