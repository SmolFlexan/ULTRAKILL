...
public class CustomFogController : MonoBehaviour
{
	...
	private void Start()
	{
		...
		disabledButton.interactable = !fogDisabled;
		disabledShopButton.deactivated = fogDisabled;
		staticButton.interactable = !fogStatic;
		staticShopButton.deactivated = fogStatic;
		dynamicButton.interactable = !fogDynamic;
		...
		colorImage.color = new Color(redAmount, greenAmount, blueAmount);
