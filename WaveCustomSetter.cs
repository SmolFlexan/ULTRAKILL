...
public class WaveCustomSetter : MonoBehaviour
{
	...
	public int wave
	{
		...
		{
			_wave = value;
			buttonText.SetText(wave.ToString());
			UpdateChangeButtons();
		}
	}
	...
	public ButtonState state
	{
		...
		{
			_state = value;
			button.interactable = state == ButtonState.Unselected;
