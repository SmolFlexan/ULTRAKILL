...
{
	private static readonly plog.Logger Log = new plog.Logger("EnemySpawnableInstance");
	...
	public override void Awake()
	{
		...
		if (eid == null)
		{
			Log.Error("EnemyIdentifier component not found on this enemy instance. Whar....");
		}
		if (eid != null)
		{
