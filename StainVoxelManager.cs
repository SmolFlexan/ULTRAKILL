...
public class StainVoxelManager : MonoSingleton<StainVoxelManager>
{
	...
	private struct UpdateMatrixJob : IJobParallelForTransform
	{
		...
		public void Execute(int index, TransformAccess transform)
		{
			...
			{
				OutMatrices[index] = transform.localToWorldMatrix;
			}
		}
	}
	...
	private void UpdateStainVisuals()
	{
		if (jobHandle.IsCompleted)
		{
			...
			stainBuffer.SetData(gasolineTransforms, 0, 0, num);
	...
	private void LateUpdate()
	{
		if (usedComputeShadersAtStart && removeLate)
		{
			...
			stainBuffer.SetData(gasolineTransforms, 0, 0, currentStainCount);
			removeLate = false;
		}
	}
	...
	private void Update()
	{
		...
		lastPropagationTick = 0f - UnityEngine.Random.Range(0f, 0.005f);
