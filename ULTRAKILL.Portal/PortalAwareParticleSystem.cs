...
public sealed class PortalAwareParticleSystem : MonoBehaviour
{
	...
	{
		toWorld = Matrix4x4.TRS(_system.transform.position, _system.transform.rotation, Vector3.one);
		Matrix4x4.Inverse3DAffine(toWorld, ref Unsafe.As<float4x4, Matrix4x4>(ref toLocal));
